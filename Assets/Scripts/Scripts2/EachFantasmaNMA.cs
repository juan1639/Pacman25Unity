...
public class EachFantasmaNMA : MonoBehaviour
{
    // ****** FANTASMA ROJO (Persigue siempre) *******
    private NavMeshAgent agent;
    [SerializeField] private Transform pacman;
    public Vector3 initialPosition = new Vector3(-3.5f, 1.5f, 8.5f);
    [SerializeField] private Vector3 scaredPosition = new Vector3(-1.5f, 1.5f, 8.5f);
    ...
    private void SetGhostDestination()
    {
        ...
        //print(FantasmasController.instance.GetVEL_NORMAL());
    }
