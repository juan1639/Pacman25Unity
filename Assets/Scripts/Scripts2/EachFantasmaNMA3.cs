...
public class EachFantasmaNMA3 : MonoBehaviour
{
    // *********** FANTASMA VERDE (No nos persigue nunca) **********
    private NavMeshAgent agent;
    private Vector3[] wayPoints;
    [SerializeField] private Transform pacman;

    public Vector3 initialPosition = new Vector3(-15.5f, 1.5f, 8.5f);
    [SerializeField] private Vector3 scaredPosition = new Vector3(-17.5f, 1.5f, 8.5f);
